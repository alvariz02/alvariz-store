...
//     strategy: "jwt",
//   },
//   secret: process.env.NEXTAUTH_SECRET || "", // Pastikan NEXTAUTH_SECRET telah diinisialisasi
//   providers: [
//     CredentialsProvider({
//       type: "credentials",
//       name: "Credentials",
...
//           if (!user) return null; // Handle user not found
//           const passwordConfirm = await compare(password, user.password);
//           if (!passwordConfirm) return null; // Handle wrong password
//           return user;
//         } catch (error) {
